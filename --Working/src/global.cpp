...
namespace ports {
  ...
  pros::Motor * liftMotor = new pros::Motor(21);
  pros::Motor * intakeMotorLeft = new pros::Motor(20, GEARSET_200, REV, ENCODER_DEGREES);
  pros::Motor * intakeMotorRight = new pros::Motor(19);
  pros::Motor * tiltMotor = new pros::Motor(21);
