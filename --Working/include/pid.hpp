...
class PID {
  public:
     ...
     * iLimit (integral limit): the maximum value the integral term can contribute to the final output power
     ...
     */
    explicit PID(int dt, double kp, double ki, double kd, bool brake, int tLimit, int iLimit, int dThreshold, int tThreshold, int de0);
